...
namespace ExemploApiCatalogoJogos.Services
{
    public class JogoService : IJogoService
    {
        ...
        public async Task<List<JogoViewModel>> Obter(int anoLancamento)
        {
            var jogos = await _jogoRepository.Obter(anoLancamento);
        ...
        public async Task Atualizar(Guid id, JogoInputModel jogo)
        {
            ...
            entidadeJogo.AnoLancamento = jogo.AnoLancamento;
        ...
        Task<JogoViewModel> IJogoService.Obter(int anoLancamento)
        {
