...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// <summary>
        /// Buscar todos os jogos pelo ano de lançamento
        /// </summary>
        /// <remarks>
        /// Não é possível retornar os jogos sem ano
        /// </remarks>
        /// <param name="anoLancamento">Indica o ano que o jogo foi lancado</param>
        /// <response code="200">Retorna a lista de jogos</response>
        /// <response code="204">Caso não haja jogos</response>   
        [HttpGet("{anoLancamento:int}")]
        public async Task<ActionResult<IEnumerable<JogoViewModel>>> Obter(int anoLancamento)
        {
            var jogos = await _jogoService.Obter(anoLancamento);

            if (jogos.AnoLancamento == 0)
                return NoContent();
